        ...
        <div className="min-h-screen bg-white text-gray-900">
            ...
            <header className="bg-linear-to-r from-blue-600 to-blue-700 text-white py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    ...
                    <p className="text-xl text-blue-100">Digital Marketplace Platform</p>
            ...
            <main className="max-w-4xl mx-auto px-4 py-12">
                ...
                <section className="mb-12">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed">
                        ...
                        digital commerce with instant delivery capabilities. Featuring
                        OAuth authentication, Stripe payment integration, and
                        sophisticated file management, DevCart empowers both sellers and
                        buyers with a seamless, secure shopping experience.
                    </p>
                </section>
                        ...
                        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
                            ...
                            <ul className="space-y-3">
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        <strong>Intuitive Studio Dashboard</strong> –
                                        Create, manage, and publish product listings
                                ...
                                <li className="flex gap-3">
                                    <span className="text-blue-600 font-bold">•</span>
                                    <div>
                                        <strong>Secure File Distribution</strong> –
                                        Maintain control over digital assets with private,
                                ...
                                <li className="flex gap-3">
                                    <span className="text-blue-600 font-bold">•</span>
                                    <div>
                                        <strong>Transaction Transparency</strong> – Track
                                        all sales and revenue in real-time
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <span className="text-blue-600 font-bold">•</span>
                                    <div>
                                        <strong>Global Reach</strong> – Publish products
                                        instantly to a searchable marketplace
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                            ...
                            <ul className="space-y-3">
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        <strong>Instant Access</strong> – Purchase and
                                        download products instantly
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <span className="text-green-600 font-bold">•</span>
                                    <div>
                                        <strong>Safe Transactions</strong> – Purchase
                                        history and re-download capabilities
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                    <span className="text-green-600 font-bold">•</span>
                                    <div>
                                        <strong>Smart Discovery</strong> – Browse with
                                ...
                                <li className="flex gap-3">
                                    <span className="text-green-600 font-bold">•</span>
                                    <div>
                                        <strong>Flexible Shopping</strong> – Cart
                                        management with secure Stripe checkout
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="space-y-6">
                        <div className="border-l-4 border-blue-600 pl-6">
                            ...
                            <p className="text-gray-700">
                                Browse marketplace → Filter by category/price → View
                                detailed product → Add to cart → Secure checkout via
                                Stripe → Instant download access
                            </p>
                        </div>
                        ...
                        <div className="border-l-4 border-green-600 pl-6">
                            ...
                            <p className="text-gray-700">
                                ...
                                product → Upload cover images → Attach downloadable file →
                                Set pricing → Publish → Monitor sales
                            </p>
                        </div>
                        ...
                        <div className="border-l-4 border-red-600 pl-6">
                            ...
                            <ul className="text-gray-700 space-y-1">
                                ...
                                <li>
                                    • Rate-limited endpoints preventing resource
                                    exhaustion
                                </li>
                            </ul>
                        </div>
                ...
                <section className="mb-12">
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg">
                        <p className="text-gray-700 mb-4">
                            DevCart operates as a multi-vendor marketplace with
                            transactional revenue model:
                        </p>
                        <ul className="space-y-2 text-gray-700">
                            <li>• Per-transaction fees on digital product sales</li>
                            <li>
                                • Scalable economics – No per-product costs, unlimited
                                inventory
                            </li>
                ...
                <section className="border-t-2 border-gray-200 pt-8 mt-12">
                    <div className="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p className="text-sm text-gray-500">
                                <strong>License:</strong> Available in repository LICENSE
                                file
                            </p>
                        </div>
                    </div>
                    <p className="text-center text-gray-600 text-sm">
                        DevCart © {new Date().getFullYear()} — Complete Solution for
